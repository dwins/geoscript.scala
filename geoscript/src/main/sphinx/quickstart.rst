...
.. literalinclude:: sample.build.sbt
   :language: scala
...
From here, you can view the ``documentation <../learning`` to learn more about what GeoScript Scala can do, or the ``reference <api>`` for the GeoScript Scala API.
If you're new to Scala, there's a quick ``Scala tutorial <introduction>`` as well as the community documenation at http://docs.scala-lang.org/ .
